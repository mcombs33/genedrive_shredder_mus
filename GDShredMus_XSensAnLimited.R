### Title: Script to run limited sensitivity analysis of X-Shredder gene drive
...
tparms.csv<-read.csv(file="XSensAnLimited_parms.csv", header=T)#import csv of params
