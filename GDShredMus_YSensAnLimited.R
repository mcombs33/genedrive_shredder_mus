### Title: Script to run limited sensitivity analysis of Y-Shredder gene drive
...
tparms.csv<-read.csv(file="YSensAnLimited_parms.csv", header=T)#import csv of params
